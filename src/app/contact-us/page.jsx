          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <input
                ...
                className="w-full sm:w-1/2 p-4 bg-gray-800 border border-green-400 rounded-md text-white"
                required
              />
              <input
                type="email"
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full p-4 bg-gray-800 border border-green-400 rounded-md text-white h-32"
              required
            ></textarea>
            <button
              type="submit"
