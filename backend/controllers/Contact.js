...
exports.addQuery = async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      subject: "Anurag Techologies - New Enquiry",
      html: `
            <html>
                <body>
                    <h2>Dear Anurag Technologies,</h2>
...
exports.deleteQuery = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: process.env.USER_EMAIL,
      to: enquries.email,
      subject: "AnuragTechologies - Irrelevant Request Found",
      html: `
            <html>
                <body>
                    ...
                    <br>
                    <p>Best regards,</p>
                    <p><strong>AnuragTechnologies</strong></p>
                </body>
            </html>
        `,
    };
...
exports.reply = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: process.env.USER_EMAIL,
      to: enquries.email,
      subject: "AnuragTechologies - Reply To Your Request",
      html: `
        <html>
          <body style="font-family: Arial, sans-serif; line-height: 1.6;">
            ...
            <br>
            <p>Best regards,</p>
            <p><strong>Team AnuragTechnologies</strong></p>
...
const checkUnreadMessages = async () => {
  ...
  if (unreadCount >= 1) {
    ...
    console.log("No Un-read Message Found");
  }
};
